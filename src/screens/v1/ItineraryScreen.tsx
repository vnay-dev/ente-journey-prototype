...
import { ItineraryAddPhotosSheet } from "../../components/v1/itinerary/ItineraryAddPhotosSheet";
import { SharedWebNav } from "../../components/v1/itinerary/SharedWebNav";
import { ItineraryShareSheet } from "../../components/v1/itinerary/ItineraryShareSheet";
import { ItineraryPhotoPreview } from "../../components/v1/itinerary/ItineraryPhotoPreview";
import { EnsuChatSheet } from "../../components/v1/itinerary/EnsuChatSheet";
import { ItineraryAppBar } from "../../components/v1/itinerary/ItineraryAppBar";
import { ItineraryEditFab } from "../../components/v1/itinerary/ItineraryEditFab";
import { ItineraryHeroTitle } from "../../components/v1/itinerary/ItineraryHeroTitle";
import { ItineraryStopCard } from "../../components/v1/itinerary/ItineraryStopCard";
import { ItineraryStoryViewer } from "../../components/v1/ItineraryStoryViewer";
import type { EnsuChatResult } from "../../components/v1/itinerary/EnsuChatSheet";
import {
  applyEnsuMessage,
  demoItinerary,
...
export function V1ItineraryScreen({ shared = false }: Props) {
  ...
  const [itinerary, setItinerary] = useState<Itinerary>(demoItinerary);
  ...
  const goToChange = useCallback(
    (
      ...
      setHighlight(null);
      requestAnimationFrame(() => setHighlight(nextHighlight));
    },
    [itinerary],
  );
  ...
  async function handleEnsuMessage(message: string): Promise<EnsuChatResult> {
    ...
    if (result.highlight) {
      goToChange(result.highlight, { sourceItinerary: result.itinerary });
    }
